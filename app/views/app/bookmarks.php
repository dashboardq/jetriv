...
<?php /*
                            <li class="post_meta">
                                <a href="https://twitter.com/<?php esc($item->author->username . '/status/' . $item->id); ?>"><img src="/assets/images/twitter_logo.svg" alt="Twitter Logo" /></a>
                                <a href="/<?php esc($item->author->username . '/status/' . $item->id); ?>"><?php esc(elapsed($item->created_at)); ?></a>
                            </li>
 */ ?>
                        </ul>
                        <div class="post">
                        ...
                        <?php if($i == 0): ?>
                        <div class="notes">
							This is a unique note to remember in the future.
                        </div>
                        <?php endif; ?>
                    </article>
                    <?php endforeach; ?>
